...
Before running the connectivity tests you need to install `cilium-cli
<https://github.com/cilium/cilium-cli#installation>`_. Alternatively, ``cilium-cli``
can be manually built and installed by fetching `https://github.com/cilium/cilium-cli`,
...
Afterwards, you need to install Cilium. The prefered way is to use
...
.. code-block:: shell-session
    ...
    $ cilium install --wait --rollback=false \
        --chart-directory=$GOPATH/src/github.com/cilium/cilium-oss/install/kubernetes/cilium \
...
and a registry cointaining prebuilt VM images.
...
Developing End-To-End Connectivity Tests
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
